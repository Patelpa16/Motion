...
function cakeAnimation(){
    ...
    tl.to("#c_line_blue_p",{ duration: 1.05, rotate: 445, ease: "power2.inOut" },"c_line_blue")
        ...
        .set("#c_line_pink_p,#c_line_yellow_p",{ opacity: 0 },"c_line_blue+=" + 3.4).to("#c_group_outer",{ duration: 1.6, rotate: 55, ease: "linear" },"c_line_blue+=" + 0.8)
        ...
        .to("#kh_group_outer",{duration: 1.2,ease: "power1.in",motionPath: {path: "#kh_group_road",align: "#kh_group_road",alignOrigin: [0, 1],start: 0.6,end: 0.9325}},"c_line_blue+=" + 2.4)
